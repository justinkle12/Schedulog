...
class ImageSelect : AppCompatActivity() {
    ...
    private lateinit var binding: SelectImageBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        Timber.i("onCreate Called")

        binding = SelectImageBinding.inflate(layoutInflater)
        ...
        if (savedInstanceState == null) {
            ...
            val postFragment = FeedTestFragment() // Create an instance of your PostFragment
