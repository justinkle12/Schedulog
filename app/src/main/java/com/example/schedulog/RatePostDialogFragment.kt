...
class RatePostDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        submitButton.setOnClickListener {
            ...
            val postId = (arguments?.getString("post_id"))?.toInt()?.plus(1).toString()
            ...
            val everyRatingRef: DatabaseReference = database.getReference("post_ratings/post_id_$postId")
            everyRatingRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    if (ratings.isNotEmpty()) {
                        ...
                        val averageRatingRef = database.getReference("posts/post_id_$postId/average_rating")
    ...
    private fun sendPostRating(ratedPostId: String, rating: Float, review: String) {
        ...
        if (currentUserId != null && rating in 0.0..5.0) {
            ...
            val userRatingsRef: DatabaseReference =
                database.getReference("post_ratings/post_id_$ratedPostId/$currentUserId")
    ...
    companion object {
        ...
        fun newInstance(postItem: PostItem): RatePostDialogFragment {
            ...
            val args = Bundle()
            args.putString("post_id", postItem.post_id.toString())
